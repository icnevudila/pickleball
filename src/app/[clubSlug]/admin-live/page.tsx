...
// Mock helper to simulate getting the current session
// In reality, this would be a param or derived from the club slug
const MOCK_SESSION_ID = "friday-open-play";

export default async function AdminLiveCourtsPage({
  params,
}: {
                  ...
                  <div className="flex flex-col p-5">
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        ...
                        <div className="text-xs text-[var(--faint)]">Tap avatar to edit · timer syncs to TV</div>
                      </div>
                      <Button variant="ghost" size="sm" className="h-8 text-[11px] uppercase tracking-wider">
                        <span className="mr-1.5 inline-flex h-2 w-2 rounded-full bg-[var(--line-strong)]"></span>
                        SCORE OFF
                      </Button>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <div className="text-xs font-bold text-[var(--foreground)] mt-2">
                          {court.teamA.map(p => p.firstName).join(" / ")}
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <div className="text-xs font-bold text-[var(--foreground)] mt-2">
                          {court.teamB.map(p => p.firstName).join(" / ")}
                        </div>
                      </div>
                    </div>
